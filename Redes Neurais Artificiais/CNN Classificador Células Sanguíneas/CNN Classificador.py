...
base_treino = gerador_treino.flow_from_directory('C:/Users/Fernando/Desktop/CNN_CELULAS/dataset/TRAIN/',
                                                 target_size = (128,128),
                                                 batch_size = 16,
                                                 class_mode = 'binary')
base_teste = gerador_teste.flow_from_directory('C:/Users/Fernando/Desktop/CNN_CELULAS/dataset/TEST/',
                                               target_size = (128,128),
                                               batch_size = 16,
                                               class_mode = 'binary')
...
classificador2.save('C:/Users/Fernando/Desktop/CNN_CELULAS/classificador2.h5',
                    overwrite=True,
                    include_optimizer=True,
                    save_format=True,
                    options = True)
classificador2.save_weights('C:/Users/Fernando/Desktop/CNN_CELULAS/classificador2_weights.h5')
